...
public class ManualTest
{
    ...
    // {
    //     using StreamWriter sw = File.CreateText(OutFileName("TestAspect", FileExtType.Text));
    //     Aspects aspects = new();
    //     foreach (string fileName in fileNames)
    //         aspects.Add(OutFileName(fileName, FileExtType.Cm));
    //     //sw.Write(aspects.ToString());

    //     string spFileName = OutFileName("Aspects", FileExtType.Text);
